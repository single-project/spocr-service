...
@Slf4j
@Component
public class ShopSpecializationServiceFacade extends
    BaseServiceFacade<ShopSpecialization, ClassifierView> {

  public ShopSpecializationServiceFacade(
      ServiceI<ShopSpecialization> service, MapperI<ShopSpecialization, ClassifierView> mapper,
